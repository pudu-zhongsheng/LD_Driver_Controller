/****************************************************************************
** Meta object code from reading C++ file 'load_base.h'
**
...
#error "The header file 'load_base.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LoadBase_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LoadBase_t qt_meta_stringdata_LoadBase = {
    {
QT_MOC_LITERAL(0, 0, 8), // "LoadBase"
QT_MOC_LITERAL(1, 9, 15), // "serialConnected"
...
static const uint qt_meta_data_LoadBase[] = {
...
void LoadBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LoadBase *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoadBase::serialConnected)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoadBase::serialDisconnected)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject LoadBase::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_LoadBase.data,
    qt_meta_data_LoadBase,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *LoadBase::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *LoadBase::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_LoadBase.stringdata0))
        return static_cast<void*>(this);
    return QWidget::qt_metacast(_clname);
}

int LoadBase::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void LoadBase::serialConnected(const QString & _t1)
{
...
// SIGNAL 1
void LoadBase::serialDisconnected()
{
