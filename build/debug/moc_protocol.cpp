...
void Protocol::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Protocol::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Protocol::error)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Protocol::error(const QString & _t1)
{
