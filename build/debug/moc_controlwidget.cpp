...
#include <memory>
#include "../../devices/driver/widgets/controlwidget.h"
...
QT_MOC_LITERAL(1, 14, 14), // "controlChanged"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "ControlWidget\0controlChanged\0"
};
...
void ControlWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ControlWidget::controlChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ControlWidget::controlChanged()
{
